...
export default function reducer(state = initialState, action) {
    switch (action.type) {
        ...
        case Constants.FILTER_SPINNER_VISIBLE: return Object.assign({}, state, { spinners: Object.assign({}, state.spinners, { filterSpinnerVisible: action.payload }) });
